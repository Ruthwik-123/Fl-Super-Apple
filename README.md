...
5. **Apple-like UI** — SF-adjacent typography, dark studio, progress bar, chapter rail.
6. **Low-end GPU** — render-on-scroll only (the model freezes when you stop), no shadows/PBR/AA, 1280px render cap, Phong/Lambert materials. Aimed at Intel i3 iGPUs and ~2016 mobile GPUs.
